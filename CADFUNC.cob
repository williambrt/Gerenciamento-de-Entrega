       ...
       DATA DIVISION.
       FILE SECTION.
       FD FILE1 VALUE OF FILE-ID IS "funcionarios.dat".
       01 FILE1-REC.
           05 FS-KEY.
               10 FS-CODFUNC PIC 9(07) BLANK WHEN ZEROS.
           05 FS-CPF         PIC 9(14).
           05 FS-NOME    PIC X(40).
       ...
       01 SS-CLS.
           05 SS-FILLER.
               ...
               10 LINE WS-NUML COLUMN 01 ERASE EOL
                  BACKGROUND-COLOR COR-FUNDO.
           05 SS-CABECALHO.
               10 LINE 01 COLUMN 02 PIC X(34) FROM WS-MODULO
       ...
       01 SS-TELA-REGISTRO.
           05 SS-CHAVE FOREGROUND-COLOR 2.
               10 LINE 10 COLUMN 10 VALUE "CODIGO FUNCIONARIO:".
               10 COLUMN PLUS 2 PIC 9(03) USING FS-CODFUNC
                  BLANK WHEN ZEROS.
           05 SS-DADOS.
               10 LINE 11 COLUMN 10 VALUE "               CPF:".
      ...
      * -----------------------------------
       ...
       INCLUI-LOOP.
           ...
           IF COB-CRT-STATUS = COB-SCR-ESC
               GO INCLUI-FIM
           END-IF
           IF FS-CPF EQUAL SPACES OR FS-NOME EQUAL SPACES
               MOVE "FAVOR INFORMAR NOME E CPF" TO WS-MSGERRO
               PERFORM MOSTRA-ERRO
               GO INCLUI-LOOP
           END-IF
           WRITE FILE1-REC
